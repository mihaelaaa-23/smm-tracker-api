...
export default function ClientCard({ client, onDelete, onTogglePriority, onEdit }: ClientCardProps) {
  ...
  return (
    <div
      className="group bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl p-6 flex flex-col gap-4 shadow-[0_1px_4px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_4px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.10)] dark:hover:shadow-[0_8px_30px_rgba(0,0,0,0.5)] hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
    ...
    >
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            onClick={(e) => { e.stopPropagation(); onTogglePriority(client.id!, !client.priority) }}
            className={`p-1.5 rounded-lg transition-all ${client.priority
